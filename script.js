...
async function getWeatherData(cityValue){
    try{
        ...
        const longLat = `Latitude: ${data.coord.lat}, Longitude: ${data.coord.lon}`;
        ...
        weatherDataEle.querySelector(".details").style.display = "flex";
        ...
        weatherDataEle.querySelector(".details").style.display = "none";
